  ...
  return (
    <div className="sidenav_body primary_bg  h-100">
      <div className="p-2 px-3">
                  ...
                  <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Arrow" transform="translate(-96.000000, 0.000000)" fillRule="nonzero">
                      <g id="arrow_left_line" transform="translate(96.000000, 0.000000)">
                        ...
                        <path d="M3.63603,11.293 C3.24551,11.6835 3.24551,12.3167 3.63603,12.7072 L9.29289,18.3641 C9.68341,18.7546 10.3166,18.7546 10.7071,18.3641 C11.0976,17.9736 11.0976,17.3404 10.7071,16.9499 L6.75735,13.0001 L20,13.0001 C20.5523,13.0001 21,12.5524 21,12.0001 C21,11.4478 20.5523,11.0001 20,11.0001 L6.75735,11.0001 L10.7071,7.05037 C11.0976,6.65984 11.0976,6.02668 10.7071,5.63616 C10.3166,5.24563 9.68341,5.24563 9.29289,5.63616 L3.63603,11.293 Z" id="路径" fill="#FFFFFFFF"></path>
                      </g>
                    </g>
                  </g>
                </svg>
        ...
        <div className="side_search_grp d-none d-lg-flex rounded-2  align-items-center justify-content-start  ps-2 py-1"></div>
          ...
          <Link to="/frame12" className="link clickable">
            <div className="dash  my-3 d-flex align-items-end justify-content-center justify-content-lg-start">
              <div className="me-lg-2 ">
                <svg className="" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                  <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Building" transform="translate(-144.000000, -48.000000)" fillRule="nonzero">
                      <g id="home_4_fill" transform="translate(144.000000, 48.000000)">
                        <rect id="矩形" x="0" y="0" width="24" height="24"></rect>
                        <path d="M13.2,2.65 C12.4889,2.11667 11.5111,2.11667 10.8,2.65 L3.8,7.9 C3.29639,8.27771 3,8.87049 3,9.5 L3,19 C3,20.1046 3.89543,21 5,21 L8.9,21 C9.50751,21 10,20.5075 10,19.9 L10,15 C10,13.8954 10.8954,13 12,13 C13.1046,13 14,13.8954 14,15 L14,19.9 C14,20.5075 14.4925,21 15.1,21 L19,21 C20.1046,21 21,20.1046 21,19 L21,9.5 C21,8.87049 20.7036,8.27771 20.2,7.9 L13.2,2.65 Z" id="路径"></path>
                      </g>
                    </g>
                  </g>
                </svg>
            ...
            <li className={`my-4 `}>
              <Link to="/frame9" className="link clickable d-flex clickable align-items-center justify-content-center justify-content-lg-start ">
                <div className="me-lg-2 ">
                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                      <g id="Weather" transform="translate(-576.000000, -48.000000)" fillRule="nonzero">
                        <g id="sun_cloudy_fill" transform="translate(576.000000, 48.000000)">
                          <rect id="矩形" x="0" y="0" width="24" height="24"></rect>
                          <path d="M11,6 C13.6623,6 15.9179,7.73309 16.7033,10.1322 C19.1625,10.6813 21,12.8756 21,15.5 C21,18.4635122 18.6562522,20.8795407 15.7212095,20.9956329 L15.5,21 L6.5,21 C4.01472,21 2,18.9853 2,16.5 C2,14.5384 3.2545,12.8708 5.00531,12.2544 C5.00178,12.17 5,12.0852 5,12 C5,8.68629 7.68629,6 11,6 Z M16.0001,3 C19.3138,3 22.0001,5.68629 22.0001,9 C22.0001,10.1679 21.6664,11.2578 21.0892,12.1797 C20.2816,10.8231 18.994,9.78544 17.4608,9.30094 C16.4667,6.92421 14.1994,5.21247 11.5115,5.0184 C12.6106,3.78022 14.2142,3 16.0001,3 Z" id="形状"></path>
                        </g>
                      </g>
                    </g>
                  </svg>
                </div>
                <h6 className="mb-0 secondary_text d-none d-lg-block">Weather Forcasting</h6>
              </Link>
            </li>
            ...
            <li className="my-4 ">
              <Link to="/frame7" className="link clickable d-flex clickable align-items-center justify-content-center justify-content-lg-start ">
                <div className="me-lg-2 ">
                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                      <g id="Transport" transform="translate(0.000000, -48.000000)" fillRule="nonzero">
                        <g id="truck_fill" transform="translate(0.000000, 48.000000)">
                          <rect id="矩形" x="0" y="0" width="24" height="24"></rect>
                          <path d="M15,4 C16.1046,4 17,4.89543 17,6 L17,7 L18.5194,7 C19.1269,7 19.7016,7.27618 20.0811,7.75061 L21.5617,9.6014 C21.8454,9.956 22,10.3966 22,10.8508 L22,15 C22,16.1046 21.1046,17 20,17 L19,17 C19,18.6569 17.6569,20 16,20 C14.3431,20 13,18.6569 13,17 L10,17 C10,18.6569 8.65685,20 7,20 C5.34315,20 4,18.6569 4,17 C2.89543,17 2,16.1046 2,15 L2,6 C2,4.89543 2.89543,4 4,4 L15,4 Z M7,16 C6.44772,16 6,16.4477 6,17 C6,17.5523 6.44772,18 7,18 C7.55228,18 8,17.5523 8,17 C8,16.4477 7.55228,16 7,16 Z M16,16 C15.4477,16 15,16.4477 15,17 C15,17.5523 15.4477,18 16,18 C16.5523,18 17,17.5523 17,17 C17,16.4477 16.5523,16 16,16 Z M18.5194,9 L17,9 L17,13 L20,13 L20,10.8508 L18.5194,9 Z" id="形状"></path>
                        </g>
                      </g>
                    </g>
                  </svg>
                </div>
                <h6 className="mb-0 secondary_text d-none d-lg-block">Vehichle Condition Monitoring</h6>
              </Link>
            </li>
            ...
            <li className="my-4 ">
              <Link to="/frame4" className="link clickable d-flex clickable align-items-center justify-content-center justify-content-lg-start ">
                <div className="me-lg-2 ">
                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                      <g id="Contact" transform="translate(0.000000, -48.000000)" fillRule="nonzero">
                        <g id="chat_1_fill" transform="translate(0.000000, 48.000000)">
                          <rect id="矩形" x="0" y="0" width="24" height="24"></rect>
                          <path d="M12,2 C17.5228,2 22,6.47715 22,12 C22,17.5228 17.5228,22 12,22 L4,22 C2.89543,22 2,21.1046 2,20 L2,12 C2,6.47715 6.47715,2 12,2 Z M12,14 L9,14 C8.44772,14 8,14.4477 8,15 C8,15.5523 8.44772,16 9,16 L12,16 C12.5523,16 13,15.5523 13,15 C13,14.4477 12.5523,14 12,14 Z M15,10 L9,10 C8.44772,10 8,10.4477 8,11 C8,11.51285 8.38604429,11.9355092 8.88337975,11.9932725 L9,12 L15,12 C15.5523,12 16,11.5523 16,11 C16,10.48715 15.613973,10.0644908 15.1166239,10.0067275 L15,10 Z" id="形状"></path>
                        </g>
                      </g>
                    </g>
                  </svg>
                </div>
                <h6 className="mb-0 secondary_text d-none d-lg-block">Additional Requests</h6>
              </Link>
            </li>
            ...
            <li className="my-4 ">
              <Link to="/frame1" className="link clickable d-flex clickable align-items-center justify-content-center justify-content-lg-start ">
                <div className="me-lg-2 ">
                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g id="页面-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                      <g id="Business" transform="translate(-144.000000, -48.000000)" fillRule="nonzero">
                        <g id="calendar_fill" transform="translate(144.000000, 48.000000)">
                          <rect id="矩形" x="0" y="0" width="24" height="24"></rect>
                          <path d="M21,12 L21,19 C21,20.1046 20.1046,21 19,21 L5,21 C3.89543,21 3,20.1046 3,19 L3,12 L21,12 Z M16,3 C16.5523,3 17,3.44772 17,4 L17,5 L19,5 C20.1046,5 21,5.89543 21,7 L21,10 L3,10 L3,7 C3,5.89543 3.89543,5 5,5 L7,5 L7,4 C7,3.44772 7.44772,3 8,3 C8.55228,3 9,3.44772 9,4 L9,5 L15,5 L15,4 C15,3.44772 15.4477,3 16,3 Z" id="形状"></path>
                        </g>
                      </g>
                    </g>
                  </svg>
                </div>
                <h6 className="mb-0 secondary_text d-none d-lg-block">View Time Table</h6>
              </Link>
            </li>
          </ul>
        </div>
      ...
      <div className="logout w-100 py-4 d-flex align-items-center justify-content-around p-2 px-3 bottom light_text " onClick={() => navigate("/login")}>
        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
