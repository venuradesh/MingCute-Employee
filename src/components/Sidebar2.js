          ...
          <ul className="ps-0 ps-lg-4 ">
            ...
            <li className="my-4 ">
              <Link to="/frame1" className="d-flex link clickable align-items-center justify-content-center justify-content-lg-start" aria-current="page">
                ...
                <h6 className="mb-0 text-wrap secondary_text d-none d-lg-block">View Schedule</h6>
              </Link>
            </li>
            ...
            <li className="my-4 d-flex clickable align-items-center justify-content-center justify-content-lg-start">
              ...
              <h6 className="mb-0 text-wrap secondary_text d-none d-lg-block">Request Leave</h6>
            </li>
            ...
            <li className="my-4 d-flex clickable align-items-center justify-content-center justify-content-lg-start">
              ...
              <h6 className="mb-0 text-wrap secondary_text d-none d-lg-block">Vehicle Condition Monitoring</h6>
            </li>
          </ul>
        </div>
      </div>
